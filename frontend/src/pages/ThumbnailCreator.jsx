...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A dual-font, dual-color headline treatment — split across its natural line breaks: render the first line in a clean, bold regular sans-serif, filled solid white with a subtle dark outline; render every subsequent line in a bold, rough-edged brush/marker-style display font (Buchery-style), filled solid vivid red with a bright white glow/outline. Both fonts AND both colors (white and red) must be clearly and boldly present as actual fill colors within the headline itself — never a single monofont or single-color (white-only) treatment throughout. Aggressive, high-energy and high-contrast against the dark background, like a spray-painted arena banner. Do not render any secondary tagline, slogan or subtitle text anywhere in the image — only the headline text itself should appear as text, aside from the device tag. Use white and vivid red as the primary headline colors, with a subtle electric-blue accent as a secondary highlight. DEVICE TAG: place a small uppercase label reading "LEGION GEN 3" fixed in the top-left corner of the frame, inside a solid rectangular box filled with a rich, solid vivid red (#E31B23), a solid color distinctly different from and standing out clearly against the background — not a translucent or blended panel. The label text itself is always rendered in a clean, plain regular (non-display) sans-serif font, always in solid white, regardless of the theme's other colors. Present consistently in every generation of this theme, independent of the headline.
...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A friendly, rounded bold sans-serif for the main headline text — split across its natural line breaks, color the first line in white and every subsequent line in vivid purple, so both colors are clearly and boldly present in the headline itself, not just as a small accent — clean, elegant and calming. Do not render any secondary tagline, slogan or subtitle text anywhere in the image — only the headline text itself should appear as text, aside from the device tag. DEVICE TAG: place a small uppercase label reading "YOGA TAB" fixed in the top-left corner of the frame, inside a solid rectangular box filled with a rich, solid vivid purple (#7C3AED), a solid color distinctly different from and standing out clearly against the background — not a translucent or blended panel. The label text itself is always rendered in a clean, plain regular (non-display) sans-serif font, always in solid white, regardless of the theme's other colors. Present consistently in every generation of this theme, independent of the headline.
COMPOSITION: Visual hierarchy: Subject Product Headline Background. Maintain clear spacing. Avoid clutter. Keep the layout balanced. Ensure readability on mobile screens.
...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A confident, elegant bold sans-serif for the main headline text — split across its natural line breaks, color the first line in white and every subsequent line in soft brown or gold, so both colors are clearly and boldly present in the headline itself, not just as a small accent — premium, executive and aspirational. Do not render any secondary tagline, slogan or subtitle text anywhere in the image — only the headline text itself should appear as text, aside from the device tag. DEVICE TAG: place a small uppercase label reading "IDEA TAB PRO" fixed in the top-left corner of the frame, inside a solid rectangular box filled with a rich, solid warm brown (#6B4226), a solid color distinctly different from and standing out clearly against the background — not a translucent or blended panel. The label text itself is always rendered in a clean, plain regular (non-display) sans-serif font, always in solid white, regardless of the theme's other colors. Present consistently in every generation of this theme, independent of the headline.
COMPOSITION: Visual hierarchy: Subject Product Headline Background. Maintain clear spacing. Avoid clutter. Keep the layout balanced. Ensure readability on mobile screens.
...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A friendly, chunky rounded bold sans-serif for the main headline text — split across its natural line breaks, color the first line in white and every subsequent line in dark blue, so both colors are clearly and boldly present in the headline itself, not just as a small accent — casual, light-hearted and easy to read. Do not render any secondary tagline, slogan or subtitle text anywhere in the image — only the headline text itself should appear as text, aside from the device tag. DEVICE TAG: place a small uppercase label reading "MOTOPAD 60 LITE" fixed in the top-left corner of the frame, inside a solid rectangular box filled with a rich, solid dark navy blue (#1E3A8A), a solid color distinctly different from and standing out clearly against the background — not a translucent or blended panel. The label text itself is always rendered in a clean, plain regular (non-display) sans-serif font, always in solid white, regardless of the theme's other colors. Present consistently in every generation of this theme, independent of the headline.
COMPOSITION: Visual hierarchy: Subject Product Headline Background. Maintain clear spacing. Avoid clutter. Keep the layout balanced. Ensure readability on mobile screens.
...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A clean, rounded bold sans-serif for the main headline text — split across its natural line breaks, color the first line in white and every subsequent line in soft blue, so both colors are clearly and boldly present in the headline itself, not just as a small accent — calm, cozy and inviting. Do not render any secondary tagline, slogan or subtitle text anywhere in the image — only the headline text itself should appear as text, aside from the device tag. DEVICE TAG: place a small uppercase label reading "MOTOPAD 60 NEO" fixed in the top-left corner of the frame, inside a solid rectangular box filled with a rich, solid medium blue (#2C5FA8), a solid color distinctly different from and standing out clearly against the background — not a translucent or blended panel. The label text itself is always rendered in a clean, plain regular (non-display) sans-serif font, always in solid white, regardless of the theme's other colors. Present consistently in every generation of this theme, independent of the headline.
COMPOSITION: Visual hierarchy: Subject Product Headline Background. Maintain clear spacing. Avoid clutter. Keep the layout balanced. Ensure readability on mobile screens.
...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A bold, sharp-edged modern sans-serif for the main headline text — split across its natural line breaks, color the first line in bright white and every subsequent line in vivid neon green with a subtle glowing edge, so both colors are clearly and boldly present in the headline itself, not just as a small accent — sleek, moody and high-tech. Do not render any secondary tagline, slogan or subtitle text anywhere in the image — only the headline text itself should appear as text, aside from the device tag. DEVICE TAG: place a small uppercase label reading "MOTOPAD 60 PRO" fixed in the top-left corner of the frame, inside a solid rectangular box filled with a rich, solid deep green (#1F7A3D) with a thin bright neon-green glowing outline, a solid color distinctly different from and standing out clearly against the background — not a translucent or blended panel. The label text itself is always rendered in a clean, plain regular (non-display) sans-serif font, always in solid white, regardless of the theme's other colors. Present consistently in every generation of this theme, independent of the headline.
COMPOSITION: Visual hierarchy: Subject Product Headline Background. Maintain clear spacing. Avoid clutter. Keep the layout balanced. Ensure readability on mobile screens.
