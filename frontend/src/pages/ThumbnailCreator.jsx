...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A bold, rough-edged brush/marker-style display font (Buchery-style) for the main headline text in bright white with a vivid red glow/outline, paired with a clean regular sans-serif for any secondary tagline text — aggressive, high-energy and high-contrast against the dark background, like a spray-painted arena banner. Use white and vivid red as the primary text colors, with a subtle electric-blue accent as a secondary highlight. DEVICE TAG: place a small uppercase label reading "LEGION GEN 3" fixed in the top-left corner of the frame, in white or vivid red to match this theme's palette, set on a subtle rounded label chip — a soft, lightly-contrasting semi-transparent background panel that wraps snugly around the text with a little padding on all sides — so the device name stays clearly legible against any background behind it. Present consistently in every generation of this theme, independent of the headline.
