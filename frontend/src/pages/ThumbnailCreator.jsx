...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A dual-font, dual-color headline treatment — split across its natural line breaks: render the first line in a clean, bold regular sans-serif, filled solid white with a subtle dark outline; render every subsequent line in a bold, rough-edged brush/marker-style display font (Buchery-style), filled solid vivid red with a bright white glow/outline. Both fonts AND both colors (white and red) must be clearly and boldly present as actual fill colors within the headline itself — never a single monofont or single-color (white-only) treatment throughout. Aggressive, high-energy and high-contrast against the dark background, like a spray-painted arena banner. Any secondary tagline text should also use the clean regular sans-serif, in white or vivid red. Use white and vivid red as the primary text colors, with a subtle electric-blue accent as a secondary highlight. DEVICE TAG: place a small uppercase label reading "LEGION GEN 3" fixed in the top-left corner of the frame, in white or vivid red to match this theme's palette, set on a subtle rounded label chip — a soft, lightly-contrasting semi-transparent background panel that wraps snugly around the text with a little padding on all sides — so the device name stays clearly legible against any background behind it. Present consistently in every generation of this theme, independent of the headline.
...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A friendly, rounded bold sans-serif for the main headline text — split across its natural line breaks, color the first line in white and every subsequent line in vivid purple, so both colors are clearly and boldly present in the headline itself, not just as a small accent — paired with a light, flowing script/cursive accent style for any secondary tagline text in vivid purple — clean, elegant and calming. DEVICE TAG: place a small uppercase label reading "YOGA TAB" fixed in the top-left corner of the frame, in white or vivid purple to match this theme's palette, set on a subtle rounded label chip — a soft, lightly-contrasting semi-transparent background panel that wraps snugly around the text with a little padding on all sides — so the device name stays clearly legible against any background behind it. Present consistently in every generation of this theme, independent of the headline.
COMPOSITION: Visual hierarchy: Subject Product Headline Background. Maintain clear spacing. Avoid clutter. Keep the layout balanced. Ensure readability on mobile screens.
...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A confident, elegant bold sans-serif for the main headline text — split across its natural line breaks, color the first line in white and every subsequent line in soft brown or gold, so both colors are clearly and boldly present in the headline itself, not just as a small accent — paired with a refined thin-weight italic accent style for any secondary tagline text in soft brown or gold — premium, executive and aspirational. DEVICE TAG: place a small uppercase label reading "IDEA TAB PRO" fixed in the top-left corner of the frame, in white or warm brown to match this theme's palette, set on a subtle rounded label chip — a soft, lightly-contrasting semi-transparent background panel that wraps snugly around the text with a little padding on all sides — so the device name stays clearly legible against any background behind it. Present consistently in every generation of this theme, independent of the headline.
COMPOSITION: Visual hierarchy: Subject Product Headline Background. Maintain clear spacing. Avoid clutter. Keep the layout balanced. Ensure readability on mobile screens.
...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A friendly, chunky rounded bold sans-serif for the main headline text — split across its natural line breaks, color the first line in white and every subsequent line in dark blue, so both colors are clearly and boldly present in the headline itself, not just as a small accent — paired with a playful cursive/script accent style for any secondary tagline text in dark blue — casual, light-hearted and easy to read. DEVICE TAG: place a small uppercase label reading "MOTOPAD 60 LITE" fixed in the top-left corner of the frame, in white or dark blue to match this theme's palette, set on a subtle rounded label chip — a soft, lightly-contrasting semi-transparent background panel that wraps snugly around the text with a little padding on all sides — so the device name stays clearly legible against any background behind it. Present consistently in every generation of this theme, independent of the headline.
COMPOSITION: Visual hierarchy: Subject Product Headline Background. Maintain clear spacing. Avoid clutter. Keep the layout balanced. Ensure readability on mobile screens.
...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A clean, rounded bold sans-serif for the main headline text — split across its natural line breaks, color the first line in white and every subsequent line in soft blue, so both colors are clearly and boldly present in the headline itself, not just as a small accent — paired with a relaxed handwritten-style script accent for any secondary tagline text in soft blue — calm, cozy and inviting. DEVICE TAG: place a small uppercase label reading "MOTOPAD 60 NEO" fixed in the top-left corner of the frame, in white or soft blue to match this theme's palette, set on a subtle rounded label chip — a soft, lightly-contrasting semi-transparent background panel that wraps snugly around the text with a little padding on all sides — so the device name stays clearly legible against any background behind it. Present consistently in every generation of this theme, independent of the headline.
COMPOSITION: Visual hierarchy: Subject Product Headline Background. Maintain clear spacing. Avoid clutter. Keep the layout balanced. Ensure readability on mobile screens.
...
Enhance: Natural lighting, Subject visibility, Product visibility, Sharpness, Contrast, Subject separation from background
HEADLINE: {{HEADLINE}}
TYPOGRAPHY: A bold, sharp-edged modern sans-serif for the main headline text — split across its natural line breaks, color the first line in bright white and every subsequent line in vivid neon green with a subtle glowing edge, so both colors are clearly and boldly present in the headline itself, not just as a small accent — paired with a clean technical accent style for any secondary tagline text in vivid neon green — sleek, moody and high-tech. DEVICE TAG: place a small uppercase label reading "MOTOPAD 60 PRO" fixed in the top-left corner of the frame, in white or vivid neon green to match this theme's palette, set on a subtle rounded label chip — a soft, lightly-contrasting semi-transparent background panel that wraps snugly around the text with a little padding on all sides — so the device name stays clearly legible against any background behind it. Present consistently in every generation of this theme, independent of the headline.
COMPOSITION: Visual hierarchy: Subject Product Headline Background. Maintain clear spacing. Avoid clutter. Keep the layout balanced. Ensure readability on mobile screens.
